...
contract StandardTokenCS is ERC20 /*, Ownable*/ {
    event TransferFee(
        uint256 makertingTax,
        uint256 devTax,
        uint256 indexed lpTax
    );
    ...
    constructor(
        ...
        // swapPair = IUniswapV2Factory(swapFactory).createPair(
        //     address(this),
        //     weth
        // );
    ...
    // function setExclusionFromTxLimit(
    //     address account,
    //     bool value
    // ) public onlyOwner {
    ...
    // function setExclusionFromWalletLimit(
    //     address account,
    //     bool value
    // ) public onlyOwner {
    ...
    //     uint256 totalFees = tokensForMarketing +
    //         tokensForDev +
    //         tokensForLiquidity +
    //         tokensForDeployer;
    ...
    //     uint256 marketingTaxFeeETH = (ethBalance * tokensForMarketing) /
    //         totalFees;
    //     uint256 devTaxFeeETH = (ethBalance * tokensForDev) / totalFees;
    //     uint256 taxFeeForDeployer = ethBalance -
    //         lpTaxFeeETH -
    //         marketingTaxFeeETH -
    //         devTaxFeeETH;

    //     if (marketingTaxFeeETH > 0) {
    //         payable(tokenInfo.marketingFeeReceiver).transfer(
    //             marketingTaxFeeETH
    //         );
    //     }
    //     if (devTaxFeeETH > 0) {
    ...
    //             tokensForMarketing +=
    //                 (fees * tokenInfo.marketingTaxBuy) /
    //                 uBuyFee;
    //         }
